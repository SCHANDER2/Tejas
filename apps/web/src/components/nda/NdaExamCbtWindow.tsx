        ...
        <div className="flex-1 bg-slate-950 p-8 overflow-y-auto max-w-6xl mx-auto w-full">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl mb-8">
            <div className="flex items-center justify-between border-b border-slate-800 pb-6 mb-6">
              ...
              <div className="flex items-center gap-3">
                <button
                  onClick={() => exportUniversalExamPaperToPdf('nda', paperTitle, paperYearOrType, questions)}
            ...
            <div className="space-y-4 pt-4 border-t border-slate-800">
              <div className="flex items-center justify-between">
                <h3 className="font-bold text-lg text-white flex items-center gap-2">
                  <Award className="w-5 h-5 text-amber-400" /> Complete Question-by-Question Solutions & Maths/GAT Explanations
                </h3>
